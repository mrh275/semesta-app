...
// Dropdown toggle
$("ul.menu-nav").on("click", ".dropdown", function (e) {
...
$(".dropdown-menu").on("click", ".dropdown-1", function (e) {
  $(this).find(".dropdown-menu-1").toggleClass("expand", 300);
  $(this).find(".dropdown-menu-1").toggleClass("collapse", 300);
  $(this).find(".dropdown-menu-1").toggleClass("invisible", 500);
  $(this).find(".dropdown-menu-1").prev().toggleClass("active-open");
  e.stopPropagation();
  e.preventDefault();
});
