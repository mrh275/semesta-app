...
<body class="bg-body" id="top">
    ...
    <footer class="footer single-page">
            ...
            <div class="right-footer">
                ...
                <ul>
                    <li style="display: flex; align-items: center" class="address">
                        <i class="fa fa-facebook" aria-hidden="true" style="font-size: 1.1rem"></i>
                        <a href="{{ getSetting('facebook') }}" style="margin-left: 5px" target="_blank">SMAN 1 Rawamerta</a>
                    </li>
                    <li style="display: flex; align-items: center" class="address">
                        <i class="fa fa-instagram" aria-hidden="true" style="font-size: 1.1rem"></i>
                        <a href="{{ getSetting('instagram') }}" style="margin-left: 5px" target="_blank">@sman1rawamerta</a>
                    </li>
                    <li style="display: flex; align-items: center" class="address">
                        <i class="fa fa-youtube-play" aria-hidden="true"></i>
                        <a href="{{ getSetting('youtube') }}" style="margin-left: 5px" target="_blank">SMAN 1 RAWAMERTA</a>
                    </li>
                </ul>
            </div>
        </div>
