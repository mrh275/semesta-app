...
<head>
    ...
    <meta name="author" content="SMAN 1 Rawamerta" />
...
<body>
    <aside class="aside aside-fixed">
        <div class="aside-header">
            <a href="{{ url('/dashboard') }}" class="aside-logo pt-2">SMANESTA WEB</a>
        ...
        <div class="aside-body">
            <ul class="nav nav-aside">
                ...
                <li class="nav-item"><a href="{{ url('/dashboard') }}" class="nav-link"><i data-feather="grid"></i> <span>{{ __('general.dashboard') }}</span></a></li>
                @if (Auth::user()->hasRole('editor'))
                    <li class="nav-label mg-t-25">{{ __('general.content') }}</li>
                    <li class="nav-item"><a href="{{ url('/dashboard/posts/table') }}" class="nav-link"><i data-feather="send"></i> <span>{{ __('general.posts') }}</span></a></li>
                ...
                @elseif(Auth::user()->hasRole('admin'))
                    <li class="nav-label mg-t-25">{{ __('general.content') }}</li>
                    <li class="nav-item"><a href="{{ url('/dashboard/posts/table') }}" class="nav-link"><i data-feather="send"></i> <span>{{ __('general.posts') }}</span></a></li>
                    <li class="nav-item"><a href="{{ url('/dashboard/categories/table') }}" class="nav-link"><i data-feather="bookmark"></i> <span>{{ __('general.categories') }}</span></a></li>
                    <li class="nav-item"><a href="{{ url('/dashboard/tags/table') }}" class="nav-link"><i data-feather="tag"></i> <span>{{ __('general.tags') }}</span></a></li>
                    ...
                    <li class="nav-item"><a href="{{ url('/dashboard/albums/table') }}" class="nav-link"><i data-feather="folder"></i> <span>{{ __('general.albums') }}</span></a></li>
                ...
                @else
                    ...
                    <li class="nav-item"><a href="{{ url('/dashboard/pages/table') }}" class="nav-link"><i data-feather="file-text"></i> <span>{{ __('general.pages') }}</span></a></li>
                    <li class="nav-label mg-t-25">{{ __('general.appearance') }}</li>
                    <li class="nav-item"><a href="{{ url('/dashboard/themes/table') }}" class="nav-link"><i data-feather="layers"></i> <span>{{ __('general.themes') }}</span></a></li>
                    <li class="nav-item"><a href="{{ url('/dashboard/menu-manager') }}" class="nav-link"><i data-feather="list"></i> <span>{{ __('general.menu_manager') }}</span></a></li>
