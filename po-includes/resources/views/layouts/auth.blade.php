...
<body>
    <header class="navbar navbar-header navbar-header-fixed">
        <div class="navbar-brand">
            <a href="{{ url('/') }}" class="df-logo pt-2"><img src="{{ asset('po-content/uploads/logo.png') }}" style="max-width: 32px; width: 100%" alt="@yield('title')">&nbsp; {{ config('app.name') }}</a>
        </div>
        ...
        <div class="navbar-right">
            ...
            <a href="https://www.github.com/muhamadramdani275" class="btn btn-social"><i class="fab fa-github"></i></a>
        </div>
    </header>
    ...
    <footer class="footer">
        ...
        <div>
            <nav class="nav">
                <span>Made with <i class="fas fa-heart"></i> by Muhamad Ramdani Hidayatullah</span>
            </nav>
        </div>
    </footer>
